...
namespace GLib {
	...
	namespace YAML {
		[CCode (cheader_filename = "libyaml-glib.h")]
		...
		[CCode (ref_function = "g_yaml_document_ref", unref_function = "g_yaml_document_unref", param_spec_function = "g_yaml_param_spec_document", cheader_filename = "libyaml-glib.h")]
		...
		[CCode (ref_function = "g_yaml_node_ref", unref_function = "g_yaml_node_unref", param_spec_function = "g_yaml_param_spec_node", cheader_filename = "libyaml-glib.h")]
		public class Node {
			[CCode (cheader_filename = "libyaml-glib.h")]
		...
		public interface Buildable : GLib.Object {
			...
			public virtual void custom_node (GLib.YAML.Builder builder, string tag, void* node) throws GLib.Error;
		...
		[CCode (cprefix = "G_YAML_ERROR_", cheader_filename = "libyaml-glib.h")]
