...
MOUSE_X = 0.600969827586207
MOUSE_Y = -27.061310782241
MOUSE_X2 = 0.500903844019397
MOUSE_Y2 = -15485.5507088245
MOUSE_BUTTON = 1
MOUSE_SHIFT = 0
MOUSE_ALT = 0
MOUSE_CTRL = 0
plot '1' using 1:2 axes x1y2 title 'precession' with lines, '' using 1:3 with lines, '' using 1:4 with lines, '' using 1:5 with lines
#    EOF
