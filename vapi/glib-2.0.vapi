...
namespace GLib {
	...
	public class Node<G> {
		...
		public Node<G> copy();
		public unowned Node<G> insert (int position, Node<G> node);
		public unowned Node<G> insert_before (Node<G> sibling, Node<G> node);
		public unowned Node<G> insert_after (Node<G> sibling, Node<G> node);
		public unowned Node<G> append (Node<G> node);
		public unowned Node<G> prepend (Node<G> node);

		public unowned Node<G> insert_data (int postioon, G data);
		public unowned Node<G> insert_data_before (Node<G> sibling, G data);
		public unowned Node<G> append_data (G data);
		public unowned Node<G> prepend_data (G data);

		public void reverse_children ();
		public void traverse (GLib.TraverseType order, GLib.TraverseFlags flags,
							int max_depth, GLib.Node.TraverseFunc func);
		public void children_foreach (TraverseFlags flags, 
							GLib.Node.ForeachFunc func);
		public unowned Node<G> get_root();
		public unowned Node<G> find (TraverseFlags flags, G data);
		...
		public unowned Node<G> nth_child(int n);
		...
		public bool is_ancester (Node descendant);
		public uint max_height ();
		public void unlink ();
		public void destroy ();

		public delegate bool TraverseFunc(Node<G> node);
		public delegate void ForeachFunc(Node<G> node);

		/*deep copy is not implemented because CopyFunc seems to be
		  a vala thing.*/
	}
	...
	[CCode (cprefix="G_TRAVERSE_", has_type_id = false)]
