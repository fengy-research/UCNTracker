...
namespace GLX
{
	...
	public static weak string glXQueryExtensionsString (void* dpy, int screen);
	public static weak string glXQueryServerString (void* dpy, int screen, int name);
	public static weak string glXGetClientString (void* dpy, int name);
