...
namespace GLU
{
	...
	[CCode (cname="_GLUfuncptr")]
	public static delegate void GLUfuncptr ();
	...
	public static weak string gluErrorString (GL.GLenum error);
	public static weak string gluGetString (GL.GLenum name);
