...
[CCode (lower_case_cprefix ="", cheader_filename="GL/glut.h")]
namespace GLUT
{
	/* ***********************************************************************************
	 * FILE: freeglut_std.h
	...
	*\
	 ...
	 */
	public static delegate void on_glutCreateMenu (int menu);
	 ...
	 */
	public static delegate void on_glutTimerFunc (int _val1);
	public static void glutTimerFunc (uint time, on_glutTimerFunc func, int value);
	public static delegate void on_glutIdleFunc ();
	public static void glutIdleFunc (on_glutIdleFunc func);

	/*
	 * Window-specific callback functions, see freeglut_callbacks.c
	 */
	public static delegate void on_glutKeyboardFunc (uchar _val1, int _val2, int _val3);
	public static void glutKeyboardFunc (on_glutKeyboardFunc func);
	public static delegate void on_glutSpecialFunc (int _val1, int _val2, int _val3);
	public static void glutSpecialFunc (on_glutSpecialFunc func);
	public static delegate void on_glutReshapeFunc (int _val1, int _val2);
	public static void glutReshapeFunc (on_glutReshapeFunc func);
	public static delegate void on_glutVisibilityFunc (int _val1);
	public static void glutVisibilityFunc (on_glutVisibilityFunc func);
	public static delegate void on_glutDisplayFunc ();
	public static void glutDisplayFunc (on_glutDisplayFunc func);
	public static delegate void on_glutMouseFunc (int _val1, int _val2, int _val3, int _val4);
	...
	public static delegate void on_glutPassiveMotionFunc (int _val1, int _val2);
	public static void glutPassiveMotionFunc (on_glutPassiveMotionFunc func);
	public static delegate void on_glutEntryFunc (int _val1);
	public static void glutEntryFunc (on_glutEntryFunc func);

	public static delegate void on_glutKeyboardUpFunc (uchar _val1, int _val2, int _val3);
	public static void glutKeyboardUpFunc (on_glutKeyboardUpFunc func);
	public static delegate void on_glutSpecialUpFunc (int _val1, int _val2, int _val3);
	public static void glutSpecialUpFunc (on_glutSpecialUpFunc func);
	public static delegate void on_glutJoystickFunc (uint _val1, int _val2, int _val3, int _val4);
	public static void glutJoystickFunc (on_glutJoystickFunc func, int pollInterval);
	public static delegate void on_glutMenuStateFunc (int _val1);
	public static void glutMenuStateFunc (on_glutMenuStateFunc func);
	public static delegate void on_glutMenuStatusFunc (int _val1, int _val2, int _val3);
	public static void glutMenuStatusFunc (on_glutMenuStatusFunc func);
	public static delegate void on_glutOverlayDisplayFunc ();
	public static void glutOverlayDisplayFunc (on_glutOverlayDisplayFunc func);
	public static delegate void on_glutWindowStatusFunc (int _val1);
	public static void glutWindowStatusFunc (on_glutWindowStatusFunc func);

	public static delegate void on_glutSpaceballMotionFunc (int _val1, int _val2, int _val3);
	public static void glutSpaceballMotionFunc (on_glutSpaceballMotionFunc func);
	public static delegate void on_glutSpaceballRotateFunc (int _val1, int _val2, int _val3);
	public static void glutSpaceballRotateFunc (on_glutSpaceballRotateFunc func);
	public static delegate void on_glutSpaceballButtonFunc (int _val1, int _val2);
	public static void glutSpaceballButtonFunc (on_glutSpaceballButtonFunc func);
	public static delegate void on_glutButtonBoxFunc (int _val1, int _val2);
	public static void glutButtonBoxFunc (on_glutButtonBoxFunc func);
	public static delegate void on_glutDialsFunc (int _val1, int _val2);
	public static void glutDialsFunc (on_glutDialsFunc func);
	public static delegate void on_glutTabletMotionFunc (int _val1, int _val2);
	public static void glutTabletMotionFunc (on_glutTabletMotionFunc func);
	public static delegate void on_glutTabletButtonFunc (int _val1, int _val2, int _val3, int _val4);
...
//public static int  glutStrokeLength (void* font, const unsigned char* string);
	...
	*/
	 ...
	 * Window-specific callback functions, see freeglut_callbacks.c
	 */
	public static delegate void on_glutMouseWheelFunc (int _val1, int _val2, int _val3, int _val4);
	public static void glutMouseWheelFunc (on_glutMouseWheelFunc func);
	public static delegate void on_glutCloseFunc ();
	public static void glutCloseFunc (on_glutCloseFunc func);
	public static delegate void on_glutWMCloseFunc ();
	public static void glutWMCloseFunc (on_glutWMCloseFunc func);
	/* A. Donev: Also a destruction callback for menus */
	public static delegate void on_glutMenuDestroyFunc ();
